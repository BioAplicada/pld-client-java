...
public class Peticion {
	...
	@ApiModelProperty(example = "JUAN", required = true, value = "Nombre completo de la persona.")
	...
	@ApiModelProperty(example = "PRUEBA", required = true, value = "Apellido paterno de la persona.")
	...
	@ApiModelProperty(example = "CUATRO", required = true, value = "Apellido materno de la persona.")
